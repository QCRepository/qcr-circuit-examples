...
1. **Initialize** $n$ input qubits in $|0\rangle$ and one output qubit in $|1\rangle$.
...
5. **Measure** — if all input qubits read $|0\rangle$, the function is constant; any other result means it is balanced.
